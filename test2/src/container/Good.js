                    ...
                    this.state.data.map((data,index)=>{
                        return(
                            <div className='title-div' key={index}>
                                ...
                                <span className='title-span1'>精华</span>
                                <a to='/more' onClick={()=>{window.location.href=`http://localhost:3000/#/home/more?${data.id}`;console.log(window.location.href)}}>{`${data.title}`}</a>                             
